...
echo ""
info_step "Dashboard de Neovim con imagen propia (opcional):"
echo "          1. brew install ascii-image-converter imagemagick"
echo "          2. Edita nvim/.config/nvim/lua/sethy/plugins/snacks.lua"
echo "          3. Descomenta la sección 'terminal' y pon la ruta de tu imagen"
echo ""
